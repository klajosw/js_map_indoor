    ...
    onAdd: function(map) {
        ...
        for (i=levels.length-1; i>=0; i--) {
            ...
            if (level === activeLevel || originalLevel === activeLevel) {
                levelBtn.style.backgroundColor = "rgba(200,200,220,0.7)";
            }
    ...
    _levelChange: function(e) {
        if (this._map !== null) {
            if (typeof e.oldLevel !== "undefined")
                this._buttons[e.oldLevel].style.backgroundColor = "rgba(220,220,240,0.7)";
            this._buttons[e.newLevel].style.backgroundColor = "rgba(200,200,220,0.7)";
        }
    },
    setLevel: function(level) {
